Public Class Student
    ...
    Public Sub New(ByVal Optional name As String = "", ByVal Optional department As String = "", ByVal Optional grade As String = "")
        Me.Name = name
...
Module Program
    ...
    Sub AddStudent()
        ...
        Dim newStudent As New Student(name, department, grade)
        ...
        If students.Count > 0 Then
            ...
            For Each student In students
                If student.Name = searchName Then
                    Console.Write("Enter new department for " & student.Name & ": ")
